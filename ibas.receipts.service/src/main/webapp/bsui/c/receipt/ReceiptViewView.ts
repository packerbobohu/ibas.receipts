...
import { IReceiptViewView } from "../../../bsapp/receipt/index";
...
export class ReceiptViewView extends ibas.BOViewView implements IReceiptViewView {
    ...
    darw(): any {
        ...
        this.form.addContent(new sap.ui.core.Title("", { text: ibas.i18n.prop("bo_receiptitem") }));
        ...
        this.form.addContent(this.tableReceiptItem);
