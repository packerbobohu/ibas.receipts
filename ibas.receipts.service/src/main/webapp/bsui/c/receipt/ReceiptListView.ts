 ...
 * 列表视图-收款
 */
export class ReceiptListView extends ibas.BOListView implements IReceiptListView {
    /** 返回查询的对象 */
    get queryTarget(): any {
        return bo.Receipt;
    }
        ...
        this.table = new sap.ui.table.Table("", {
            ...
            columns: [
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_receipt_docentry"),
                ...
                new sap.ui.table.Column("", {
                    label: ibas.i18n.prop("bo_receipt_documentcurrency"),
                    template: new sap.m.Text("", {
                        wrapping: false
                    }).bindProperty("text", {
